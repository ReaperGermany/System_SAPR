...
<html lang="en">
	...
	<?php  
        ...
        $Tid = $_SESSION['userID'];
		$query = mysql_query("Select Suid, Name FROM subject WHERE Suid not in(SELECT Suid FROM subjectReference WHERE Tid = $Tid)", $connection);
		$res_array = array();
		...
		<div class="content">
		    <div class="sidebar">
		        ...
		        <ul id="nav">
		          ...
		          <li class="open"><a href="subject.php"><i class="fa fa-tasks"></i>Выбор предметов</a></li>
		  	...
		  	<div class="mainbar">
			    <div class="page-head">
			      	<h2 class="pull-left"><i class="fa fa-tasks"></i> Выбор предметов</h2>
			        ...
			        <div class="container">
			        	<div class="col-md-4">
			        		<div class="panel panel-default">
		                        <div class="panel-heading"><p align="center"> ВЫБЕРИТЕ ПРЕДМЕТЫ ДЛЯ ВЕДЕНИЯ КУРСОВОЙ РАБОТЫ</p></div>
		                        <div class="panel-body">
		                            <form class="" method="POST" action="subjAdd.php">
			                            <div class="col-md-8">
			        	...
			        	<?php if($_SESSION['error'] == 'выполнено') {?>
				        	<div  class="col-md-8">
								<div class="alert alert-success" role="alert"> Группа успешно добавлена в Ваш список </div>
				        	</div>
						<?php
						$_SESSION['error'] = '';
						}
