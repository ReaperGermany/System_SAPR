...
<body>
  ...
  $queryM = mysql_query("select * from Smessages inner join teachers on Smessages.Tid = teachers.Tid and Sid = '$userID' and MsgStatus = 0 order by Date Desc", $connection);
  $masMessage = array();
  $MsgID = $_GET['MsgID'];
    ...
    <div class="content">
        <div class="sidebar">
            ...
            <ul id="nav">
                ...
                <li class="open"><a href="inboxmail.php"><i class="fa fa-envelope"></i> Входящие</a></li>
                <li><a href="postmail.php"><i class="fa fa-envelope-o"></i> Исходящие</a></li>
            </ul>
        </div>
        <div class="mainbar">
          <div class="page-head">
              <h2 class="pull-left"><i class="fa fa-envelope"></i> Входящие</h2>
                          ...
                          <div class="profile-sidebar">
                            <div class="profile-usermenu">
                                <ul class="nav">
                                  ...
                                  ?>
                                    <li>
                                      <a href="inboxmail.php?MsgID=<?=$tMess['MsgID']?>" ><span class="badge"><?= $tMess['Date'] ?></span> <?= $tMess['FIO'] ?></a>
                                    </li>
                                  <?php } ?>
                                </ul>
                            </div>
                            ...
                            <div class="col-md-9">
                                <div class="panel panel-default">
                                      <form action="" method="POST">
                                        <div class="panel-heading"><b>Отправитель: <?=$tMess2['FIO'] ?> - <?=$tMess2['Date'] ?></b></div>
                                        <div class="panel-body" style="owerflow:auto">
                                          <p align="justify" style="maxlength:10000"><em><?=$tMess2['TextM'] ?></em></p>
                                          <br>      
                                        </div>
                                        <div class="panel-footer">
                                            <button type="submit" class="btn btn-warning" name="del">Написать</button>
                                            <button type="submit" class="btn btn-success" name="del">Удалить</button>
                                        </div>
                                      </form>                     
                                </div>
                            </div>
